...
`,_8=()=>S(E8,{children:S("div",{className:"footer__container",children:N("p",{children:["Disclaimer : This site has no commercial purpose and is not affiliated with any brand.",S("span",{children:"Please note: This site uses an editable public API. Therefore, it is possible that some products do not appear on the page. Normally, there are 39 shoes and 42 clothes."})]})})}),E8=Fe.footer`
  width: 100vw;
  max-width: 100%;
  background: var(--header-black-clr);
  padding: 20rem 1rem;
